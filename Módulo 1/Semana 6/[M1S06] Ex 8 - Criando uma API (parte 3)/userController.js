...
function verificarCargo(req, res, next) {
  ...
  if (cargo === "líder") {
    ...
    return res
      .status(403)
      .json({
        mensagem: "Usuário não tem permissão para acessar essa funcionalidade",
      });
  }
}

app.post("/usuarios", verificarCargo, UserController.createUser);
